  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body" style="padding: 5px;">
        <h5 class="card-title" style="float: right;"> أسم المنتج: {{ $modern['name'] }}</h5>
        <p class="card-text" style="font-weight: bold;  margin-top: 15px; float: right;"> {{ $modern['disc'] }}</p>
        <p class="card-text" style="color: blue; font-weight: bold; float: right;">السعر: {{ $modern['price'] }} YER </p>
      </div>
    </div>
